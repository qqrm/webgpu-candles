...
fn tooltip_reverse_positioning() {
    ...
    for expected_index in 0..visible_len {
        ...
        assert_eq!(rounded_index, expected_index, 
...
fn tooltip_mouse_boundaries() {
    ...
    assert!(right_index >= (visible_len - 1) as f64, 
        "Right boundary should give index >= {}, got {}", visible_len - 1, right_index);
}
